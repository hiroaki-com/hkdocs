...
last_update:
  date: 2025-06-22
tags: [docusaurus, Google Analytics, チュートリアル]
...
本記事は継続的にメンテナンスしている手順書です。執筆当時の背景や試行錯誤の記録は [ブログ版の記事](/blog/2025/06/22/docusaurus-google-analytics-ga4-integration/) を参照してください。
