...
本記事は継続的にメンテナンスしている手順書です。執筆当時の背景や試行錯誤の記録は [ブログ版の記事](/blog/2025/06/16/solving-docusaurus-i18n-routing-and-deployment-issues/) を参照してください。

<Admonition type="info" title="前提環境">
  <ul>
    <li><strong>サイトジェネレーター:</strong> Docusaurus v3</li>
    <li><strong>ホスティング:</strong> Google Cloud Run</li>
    <li><strong>開発・デプロイ:</strong> Docker, GitHub Actions</li>
    <li><strong>パッケージマネージャー:</strong> pnpm</li>
  </ul>
</Admonition>
