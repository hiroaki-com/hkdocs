---
title: Docusaurusで多言語対応ニュースリンク集のページを作成
sidebar_position: 14
last_update:
  date: 2025-07-11
authors: [hk]
...
ここでは、本サイト内に、国内外のニュースサイトを一覧できる「[ニュースページ](/news)」を実装した際の備忘録として整理します。
...
個人的な情報収集の起点として、信頼できるニュースソースへ素早くアクセスできるページの構築が目的。すべて静的ページとしてビルドし、利便性、高速な表示やメンテナンス性を重視。
