...
authors: [hk]
tags: [llm, google-colab, python, claude-code, automation]
description: "Google Colab の GPU で Ollama を動かし ngrok でエンドポイントを公開して完全無料の LLM サーバーを立てる方法。Claude Code や Continue などのコーディングアシスタントから利用できます。"
---
...
このツールをリリースした際の紹介記事は [ブログ記事](/blog/2026/03/01/release-colab-ollama-server/) にあります。
...
<div style={{ textAlign: 'center', marginBottom: '24px' }}>
  <video
    src="https://github.com/user-attachments/assets/98084bb4-6eb0-4e47-850b-f1bae0311c70"
...
リクエストがクライアントからモデルに到達するまでの流れを示します。
...
まずどのモデルが自分のユースケースに合うかを確かめたい場合は、[複数モデルを一括比較できるベンチマークツール](/docs/tech/google-colab/google-colab-ollama-multi-model-benchmarker/)も合わせてご活用ください。サーバーを立てた後は、その上にプライベートなチャットUIを載せることもできます。詳しくは [Cloudflare Tunnel でプライベートLLMチャット環境を作る手順](/docs/tech/google-colab/google-colab-ollama-private-chat-for-local-llm/) を参照してください。
