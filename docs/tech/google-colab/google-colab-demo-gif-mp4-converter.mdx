...
authors: [hk]
tags: [python, google-colab, automation]
description: "Google Colab の無料環境で ffmpeg を使い、画面録画を GIF・MP4 に変換するオープンソースツールの使い方と機能紹介。BGM 追加・動画ズームアップ機能も搭載しています。"
---
...
Google Colabの無料環境でffmpegを動かして、画面録画をそのままGIF・MP4に変換できるツールを作りました。

このツールをリリースした際の紹介記事は [ブログ記事](/blog/2026/02/19/release-colab-video-converter/) にあります。
...
デモ動画の一部を隠したい場合は、同じ FFmpeg×Colab の発想で作った [モザイク処理ツール](/docs/tech/google-colab/google-colab-mosaic-clip/) も併せてどうぞ。
