...
description: "Google Cloud Professional Cloud DevOps Engineer 認定試験の合格記。試験の難易度・出題傾向・受験当日の振り返りを実体験ベースでまとめた備忘録です。"
---
...
<Admonition type="note" title="2025/03/30 合格記">
<p>
ダブルヘッダーの洗礼を受けつつも乗り越える
</p>

**試験概要**
<ul>
  <li>出題50問、50分程度で1周完了し、10分で見直して提出</li>
  <li>9割は行ったと想像</li>
</ul>

**試験の感想**
<ul>
  <li>Udemyのコースの問題がそのまま出る or SREについて理解していれば即答の問題がほとんど</li>
  <li>アーキテクトやその他試験の浅い問題もあったのかもしれないが基礎的な問題がほとんど</li>
  <li>前半簡単だったが、後半少し不安な箇所もあったので過去問題がたまたま出たという可能性も否めない</li>
</ul>

**出題されたトピック**
<ul>
  <li>エージェント ポリシー → 2回程度出題され、あまり理解していないことを自覚</li>
  <li>プライベートプール</li>
  <li>Cloud Build 全般</li>
  <li>SREの基礎的な思想全般</li>
  <li>IAM関連／GKEサービスアカウント関連 少々</li>
  <li>SRIの余裕を持った数値定義の問題（50→60/100→110...）</li>
</ul>
</Admonition>
...
- 試験名: Google Cloud Professional Cloud DevOps Engineer
- 日付: 2025年03月30日
- 時刻: 15:45 (JST)

---
<Admonition type="tip" title="受験当日のTODO（PSE / PNE / PDE / PCA 受験時の成功事例） ⭐️">
...
<Admonition type="info" title="開発者メモ: Udemy Invalid URLs レポート">
2025/03/29 報告完了
