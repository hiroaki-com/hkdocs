...
last_update:
  date: 2025-06-10
tags: [google cloud, 認定資格, 合格記, llm]
description: "Google Cloud Professional Machine Learning Engineer 認定試験の合格記（2回目で合格）。Professional 試験中最難関の出題傾向・学習ポイントを実体験ベースでまとめた備忘録です。"
---
...
- 試験名: Google Cloud Professional Machine Learning Engineer
- 日付: 2025年04月18日
- 時刻: 13:30 (JST)
...
- Vertex AI Vizier
- TensorFlow Lite（複数）
- TensorFlow の AIアクセラレータ（TPU/GPU/CPU）の選定に関する問題
...
- [**What-If Tool**](https://www.google.com/search?q=What-If+Tool) (What-Ifツール)
    ※ モデルの性能をさまざまな入力に対してテストし、データの特徴の重要性を分析し、複数のモデルやデータセットにおけるモデルの挙動を視覚化。GoogleのOSS。
...
- GeminiやLlamaなどの最近のMODELのAPI選定に関する問題も出題された
- TensorFlow I/O
