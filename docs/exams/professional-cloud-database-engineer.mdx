...
description: "Google Cloud Professional Cloud Database Engineer 認定試験の合格記。英語試験での受験体験・出題傾向・学習のポイントをまとめた実体験の記録です。"
---
...
<ul>
<li>問題数：50問</li>
<li>100/120 程度で1周完了→ 15分程度で見直し完了し終了</li>
<li>予想得点率は75%~85%</li>
</ul>
<p>
