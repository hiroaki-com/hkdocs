...
<div style={{ display: 'flex', justifyContent: 'center', gap: '16px', marginBottom: '32px', flexWrap: 'wrap' }}>
  <img src="/img/darts-01-img.webp" alt="01 Game Darts Score Calculator Screen" style={{ maxWidth: '100%', width: '360px', borderRadius: 'var(--ifm-global-radius)', border: '1px solid var(--ifm-color-emphasis-200)' }} />
  <img src="/img/darts-cricket-img.webp" alt="Cricket Darts Score Calculator Screen" style={{ maxWidth: '100%', width: '360px', borderRadius: 'var(--ifm-global-radius)', border: '1px solid var(--ifm-color-emphasis-200)' }} />
</div>
