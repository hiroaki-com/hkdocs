...
authors: [hk]
tags: [llm, google-colab, python, privacy]
video_asset: "https://github.com/user-attachments/assets/c6e13476-5acc-4a16-ba42-b7dae86225f2"
description: "Release announcement for a Google Colab tool that runs a private LLM chat environment via Cloudflare Tunnel — conversation logs never leave your machine."
---
...
The setup steps and usage of this tool are explained in detail in the [technical documentation](/en/docs/tech/google-colab/google-colab-ollama-private-chat-for-local-llm/).
