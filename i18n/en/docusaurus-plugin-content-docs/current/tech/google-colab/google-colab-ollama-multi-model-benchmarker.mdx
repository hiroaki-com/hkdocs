...
authors: [hk]
tags: [llm, google-colab, python, automation]
description: "A Google Colab tool to simultaneously test and auto-benchmark multiple Ollama LLM models (Llama, Qwen, Mistral, etc.) with no local setup required."
---
...
The release announcement for this tool is available as a [blog post](/en/blog/2026/02/18/release-ollama-llm-benchmark/).
...
Once you've picked a model, spin up your own free LLM server with [Ollama on Google Colab's free GPU](/en/docs/tech/google-colab/google-colab-ollama-free-llm-server/), or build a [private LLM chat environment](/en/docs/tech/google-colab/google-colab-ollama-private-chat-for-local-llm/) on top of it.
