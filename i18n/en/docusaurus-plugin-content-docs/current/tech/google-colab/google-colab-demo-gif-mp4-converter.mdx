...
description: "A Google Colab tool that uses ffmpeg to convert screen recordings to GIF or MP4, with BGM addition and zoom features built into the notebook UI."
---
...
I built a tool that runs ffmpeg inside Google Colab's free environment and converts screen recordings directly to GIF or MP4.

The release announcement for this tool is available as a [blog post](/en/blog/2026/02/19/release-colab-video-converter/).
...
If you also need to blur out part of a demo, the [mosaic tool for Colab](/en/docs/tech/google-colab/google-colab-mosaic-clip/) is a companion built on the same FFmpeg-on-Colab approach.
