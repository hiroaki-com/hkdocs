...
sidebar_position: 20
authors: [hk]
tags: [docusaurus, react, typescript, web-app, ui/ux]
description: "A guide to implementing a GitHub Star button in Docusaurus — a custom component that fetches star counts via the GitHub API without OAuth."
---
