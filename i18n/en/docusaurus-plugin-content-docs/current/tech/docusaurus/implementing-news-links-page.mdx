...
last_update:
  date: 2025-07-11
authors: [hk]
tags: [docusaurus, react, typescript, i18n, css, ui/ux, performance]
description: "A guide to implementing a news links page in Docusaurus using React, TypeScript, and CSS Modules with full i18n support."
---
...
This article is a continuously maintained guide. For the background and trial-and-error from when it was first written, see the [original blog post](/en/blog/2025/07/11/implementing-news-links-page/).
