...
last_update:
  date: 2025-06-10
tags: [docusaurus, search]
description: "A guide to implementing Algolia DocSearch on a Docusaurus site for site search, including the setup process and troubleshooting."
---
...
This article is a continuously maintained guide. For the background and trial-and-error from when it was first written, see the [original blog post](/en/blog/2025/06/10/setup-sitesearch-with-algolia-docsearch/).
