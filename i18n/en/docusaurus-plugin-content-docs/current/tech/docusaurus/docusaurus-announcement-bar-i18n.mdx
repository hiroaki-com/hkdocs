...
authors: [hk]
sidebar_position: 18
tags: [docusaurus, i18n, typescript]
description: "A guide to localizing the Docusaurus announcement bar using process.env.DOCUSAURUS_CURRENT_LOCALE to switch content based on the current locale."
---
...
announcementBar: {
  ...
  content: '🚀 6月1日にメンテナンスを実施します。', // "Maintenance scheduled for June 1st."
