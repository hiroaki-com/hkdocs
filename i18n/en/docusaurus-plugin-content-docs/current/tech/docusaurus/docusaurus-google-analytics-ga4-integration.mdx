...
last_update:
  date: 2025-06-22
tags: [docusaurus, Google Analytics, tutorial]
description: "A guide to integrating Google Analytics 4 (GA4) into a Docusaurus site for access analytics, covering the gtag plugin configuration."
---
...
This article is a continuously maintained guide. For the background and trial-and-error from when it was first written, see the [original blog post](/en/blog/2025/06/22/docusaurus-google-analytics-ga4-integration/).
