...
description: "A guide to customizing Decap CMS config.yml and index.html to improve UX, covering mobile usability enhancements and streamlined field input."
---
...
This article is a continuously maintained guide. For the background and trial-and-error from when it was first written, see the [original blog post](/en/blog/2025/07/29/decap-cms-ux-tuning-for-config-and-index/).
