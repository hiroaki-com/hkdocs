...
description: "A guide to adding Japanese/English multilingual support (i18n) to a Docusaurus site, including Docker commands and pre-deployment verification steps."
---
...
This article is a continuously maintained guide. For the background and trial-and-error from when it was first written, see the [original blog post](/en/blog/2025/06/16/implementing-i18n-in-docusaurus/).
