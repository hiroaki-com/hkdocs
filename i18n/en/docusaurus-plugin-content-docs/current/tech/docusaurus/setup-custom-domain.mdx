...
description: "Step-by-step guide for setting up a custom domain on a Docusaurus site hosted on Google Cloud Run using Value Domain, from DNS configuration to Cloud Run mapping."
---
...
This article is a continuously maintained guide. For the background and trial-and-error from when it was first written, see the [original blog post](/en/blog/2025/06/09/setup-custom-domain/).
