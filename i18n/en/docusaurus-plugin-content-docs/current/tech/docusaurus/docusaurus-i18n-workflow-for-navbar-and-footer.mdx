...
last_update:
  date: 2025-06-16
tags: [docusaurus, i18n, react, typescript, ci/cd, tutorial]
description: "A guide to localizing the Docusaurus navbar and footer, covering translation file placement and a concrete workflow through to verification."
---
...
This article is a continuously maintained guide. For the background and trial-and-error from when it was first written, see the [original blog post](/en/blog/2025/06/21/docusaurus-i18n-workflow-for-navbar-and-footer/).
