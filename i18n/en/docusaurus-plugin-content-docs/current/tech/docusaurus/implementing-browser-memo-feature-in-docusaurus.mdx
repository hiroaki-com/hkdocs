...
The background and trial-and-error from the time of this implementation are recorded in the [original blog post](/en/blog/2025/06/15/implementing-browser-memo-feature-in-docusaurus/).
