...
description: "A guide to adding Mermaid diagram rendering to the Docusaurus browser memo, extending the Markdown preview to support text-based diagram creation."
---
