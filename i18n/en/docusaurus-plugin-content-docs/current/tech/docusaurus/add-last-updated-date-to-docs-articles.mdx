...
last_update:
  date: '2025-06-23'
tags: [docusaurus]
description: "A guide to displaying a last-updated date on Docusaurus Docs pages using front matter — no Git history dependency or CI/CD changes required."
---
...
This article is a continuously maintained guide. For the background and trial-and-error from when it was first written, see the [original blog post](/en/blog/2025/06/23/add-last-updated-date-to-docs-articles/).
