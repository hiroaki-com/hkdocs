...
last_update:
  date: 2025-06-18
tags: [apps-script, tutorial]
description: "A Google Apps Script to detect horizontal lines in Google Docs and bulk-replace them with specified text — automating a task that the built-in find & replace cannot handle."
---
