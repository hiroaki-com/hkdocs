...
![システム設定の壁紙メニュー](/img/mac-wallpaper-fix_1-1_mac-system-settings-wallpaper-menu.webp)

![システム設定からのファイル選択画面](/img/mac-wallpaper-fix_1-2_mac-system-settings-wallpaper-select-file.webp)
...
![Finderで壁紙用の画像を選択](/img/mac-wallpaper-fix_2-1_mac-finder-select-wallpaper-image.webp)

![Finderのサービスメニューから壁紙を設定](/img/mac-wallpaper-fix_2-2_mac-set-wallpaper-from-service.webp)

![壁紙の設定が完了したデスクトップ](/img/mac-wallpaper-fix_2-3_mac-wallpaper-setting-success.webp)
