    ...
    subCategories: [
      {
        ...
        sites: [
          ...
          { href: 'https://www.ft.com/', title: { id: 'news.site.int.ge.ft.title', message: 'Financial Times' }, description: { id: 'news.site.int.ge.ft.desc', message: '1888年に英国でジェームズ・シェリダンらにより創刊。2015年より日本経済新聞社の傘下にある経済紙。サーモンピンク色の用紙で知られ、グローバルな金融・経済報道で知られる。' } },
          { href: 'https://www.washingtonpost.com/', title: { id: 'news.site.int.ge.wapo.title', message: 'The Washington Post' }, description: { id: 'news.site.int.ge.wapo.desc', message: '1877年に米国ワシントンD.C.で創刊。グラハム家の所有を経て、2013年よりアマゾン創業者ジェフ・ベゾスが個人所有。政治・政策報道と調査報道を主軸とする全国紙。' } },
          { href: 'https://www.theguardian.com/us', title: { id: 'news.site.int.ge.guardian.title', message: 'The Guardian US' }, description: { id: 'news.site.int.ge.guardian.desc', message: '1821年に英国マンチェスターでジョン・エドワード・テイラーが『マンチェスター・ガーディアン』として創刊。非営利のスコット・トラストが所有するガーディアン・メディア・グループが運営。NSAの監視プログラム「PRISM」やパナマ文書の報道で知られるリベラル系大手紙の米国向け版。' } },
          ...
          { href: 'https://www.axios.com/', title: { id: 'news.site.int.ge.axios.title', message: 'Axios' }, description: { id: 'news.site.int.ge.axios.desc', message: '2017年にPoliticoの元幹部らが米国で設立したデジタルメディア。政治・ビジネス・テクノロジー分野を中心に、箇条書きを多用した簡潔な形式で記事を配信する。' } },
      ...
      },
      {
        ...
        sites: [
          ...
          { href: 'https://www.infoq.com/', title: { id: 'news.site.int.ts.infoq.title', message: 'InfoQ' }, description: { id: 'news.site.int.ts.infoq.desc', message: '2006年にフロイド・マリネスクらが設立。C4Media Inc.が運営。シニア開発者、アーキテクト、技術リーダー向けに、ソフトウェア開発のトレンドやベストプラクティスを実践者視点で配信。英・中・日など多言語版を展開し、技術カンファレンス「QCon」を主催する。' } },
          { href: 'https://spectrum.ieee.org/', title: { id: 'news.site.int.ts.ieeespectrum.title', message: 'IEEE Spectrum' }, description: { id: 'news.site.int.ts.ieeespectrum.desc', message: '1964年にIEEE（電気電子学会）が創刊した旗艦誌。世界最大の技術専門家組織であるIEEEの50万人超の会員に向け、工学・技術・科学分野の主要な動向を伝える。米国雑誌賞を複数回受賞している。' } },
          { href: 'https://cacm.acm.org/', title: { id: 'news.site.int.ts.cacm.title', message: 'Communications of the ACM (CACM)' }, description: { id: 'news.site.int.ts.cacm.desc', message: '1958年にACM（計算機協会、1947年設立）が創刊した旗艦誌。ニュースや専門家の論評、査読付き研究を掲載し、計算機科学の学術誌と実務者向け技術情報の両面を担う。2024年よりWeb中心のオープンアクセス媒体として再出発した。' } },
          { href: 'https://arstechnica.com/', title: { id: 'news.site.int.ts.arstechnica.title', message: 'Ars Technica' }, description: { id: 'news.site.int.ts.arstechnica.desc', message: '1998年にケン・フィッシャーとジョン・ストークスが米国で設立。2008年よりコンデナスト社が運営。テクノロジー、科学、政策分野の深掘りした技術解説記事やレビューで知られる。' } },
          { href: 'https://thenewstack.io/', title: { id: 'news.site.int.ts.thenewstack.title', message: 'The New Stack' }, description: { id: 'news.site.int.ts.thenewstack.desc', message: '2014年に技術ジャーナリストのアレックス・ウィリアムズらが米国で設立。2021年よりInsight Partnersの傘下。クラウドネイティブ、DevOps、オープンソース、コンテナ技術など、現代のアプリケーション開発基盤に特化した開発者向けメディア。' } }
        ],
      },
      {
      ...
      },
      {
        ...
        sites: [
          ...
          { href: 'https://www.foreignaffairs.com/', title: { id: 'news.site.int.ss.foreignaffairs.title', message: 'Foreign Affairs' }, description: { id: 'news.site.int.ss.foreignaffairs.desc', message: '1922年創刊。米国のシンクタンク「外交問題評議会(CFR)」が発行する国際関係・外交政策の専門誌。政治家や研究者による論文を掲載。米国国際政治の指標とされる。' } },
          { href: 'https://youranon.news/', title: { id: 'news.site.int.ss.yan.title', message: 'YourAnonNews' }, description: { id: 'news.site.int.ss.yan.desc', message: '国際的ハッカー集団「Anonymous」に関連する主要な情報発信拠点。活動家によるニュース、リーク情報、および主流メディアが扱わないトピックを集約して発信。' } },
