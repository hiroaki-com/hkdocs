    ...
    subCategories: [
      {
        ...
        sites: [
          ...
          { href: 'https://www.businessinsider.com/', title: { id: 'news.site.int.ge.bi.title', message: 'Business Insider' }, description: { id: 'news.site.int.ge.bi.desc', message: '2007年にヘンリー・ブロジェットらが米国で設立。Axel Springer SEが運営。ビジネスとテクノロジーのニュースを速報性高く配信し、世界中に複数の国際版を展開している。' } },
