...
const linksData: LinkCategoryData[] = [
  ...
  },
  {
    ...
    sites: [
      ...
      { href: 'https://thesaurus.jamas.or.jp/link/th/T006072', title: { id: 'links.site.academic.thesaurus.title', message: 'シソーラスブラウザ' }, description: { id: 'links.site.academic.thesaurus.desc', message: '医学統制語・MeSH用語の検索ツール。関連PubMed論文への直接リンクも提供。' } },
