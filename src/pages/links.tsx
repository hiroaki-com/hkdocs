...
const linksData: LinkCategoryData[] = [
  {
    ...
    sites: [
      ...
      { href: 'https://python.langchain.com/docs/introduction/', title: { id: 'links.site.backend.langchain.title', message: 'LangChain Docs' }, description: { id: 'links.site.backend.langchain.desc', message: '大規模言語モデル（LLM）を活用したアプリケーションを開発するためのPythonフレームワーク。' } },
  ...
  },
  {
    ...
    sites: [
      ...
      { href: 'https://www.mdpi.com/', title: { id: 'links.site.academic.mdpi.title', message: 'MDPI' }, description: { id: 'links.site.academic.mdpi.desc', message: 'スイス拠点の多分野学術出版社。390以上の査読付きオープンアクセス誌をCC BYライセンスで無料公開。' } },
      ...
      { href: 'https://www.ncbi.nlm.nih.gov/mesh', title: { id: 'links.site.academic.mesh.title', message: 'MeSH' }, description: { id: 'links.site.academic.mesh.desc', message: '米国国立医学図書館が管理する医学分野の統制語辞書。階層構造化された用語でPubMed等の文献検索を効率化。' } },
      { href: 'https://thesaurus.jamas.or.jp/', title: { id: 'links.site.academic.thesaurus.title', message: 'シソーラスブラウザ' }, description: { id: 'links.site.academic.thesaurus.desc', message: '医学統制語・MeSH用語の検索ツール。関連PubMed論文への直接リンクも提供。' } },
...
export default function LinksPage(): JSX.Element {
  const handleDownload = () => {
    ...
    downloadCsv('hkdocs-links-sites.csv', header, rows);
  };
